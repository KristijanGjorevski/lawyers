...
<body>
    <header>
        <nav id="nav-list_mobile">
            ...
            <ul id="mobile-menu">
                ...
                <li>
                    <a href="gallery.php" class="focus">Gallery</a>
                </li>
                <li>
    ...
    <h5 class="page_header headings" title="Gallery">Gallery</h5>
    <main class="gallery_container">
    ...
    <div id="zoomContainer" class="zoom_box">
        <span class="close">×</span>
        <img class="pic_box" id="imgfull">
        <div id="caption"></div>
    </div>
    <footer>
